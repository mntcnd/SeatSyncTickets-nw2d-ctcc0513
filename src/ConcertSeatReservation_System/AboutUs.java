...
// For images: the background and the logo
    public void Main (){
...
// Creating the components and its layout
    ...
    private void initComponents() {
        ...
        menu.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Home", "Login or Sign Up", "Contact Us", "Terms & Conditions" }));
        ...
        jLabel3.setText("SeatSync Tickets was established in 2022, with the mission to make it easier for concert goers to find ");
        ...
        jLabel1.setText("and secure seats for their favorite artists. We offer a wide variety of seating options, so that you can ");
        ...
        jLabel5.setText("find the perfect spot to enjoy the show. We believe that everyone should be able to enjoy their ");
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 250, 1420, 50));

        jLabel9.setFont(new java.awt.Font("Copperplate Gothic Light", 1, 24)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(255, 255, 255));
        jLabel9.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel9.setText("favorite music without having to be so stressed about reserving a seat at the venue the event will take");
        ...
        jLabel10.setText("place. That is why  we created an online system that makes it easy to find and reserve seats for upcoming");
        ...
        jLabel11.setText("concerts. CaRose Tickets is committed to providing excellent customer service, so if you're looking");
        getContentPane().add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 340, 1420, 50));

        jLabel12.setFont(new java.awt.Font("Copperplate Gothic Light", 1, 24)); // NOI18N
        jLabel12.setForeground(new java.awt.Color(255, 255, 255));
        jLabel12.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel12.setText("for an easy and hassle-free way to find and reserve seats for your next concert, then look no further ");
        ...
        jLabel13.setText("than CaRose Tickets!");
        ...
        jLabel14.setText("Secure a ticket to your idol's concert in a hassle and stress free manner, with us!");
        getContentPane().add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 600, 1460, 50));

        jLabel15.setFont(new java.awt.Font("Copperplate Gothic Light", 1, 24)); // NOI18N
        jLabel15.setForeground(new java.awt.Color(255, 255, 255));
        jLabel15.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel15.setText("We hope you found all of the information on CaRose Tickets helpful, as we love to share them with you.");
        getContentPane().add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 480, 1460, 50));

        jLabel16.setFont(new java.awt.Font("Copperplate Gothic Light", 1, 24)); // NOI18N
        jLabel16.setForeground(new java.awt.Color(255, 255, 255));
        jLabel16.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel16.setText("If you require any more information or have any questions about our site, please feel free to contact us ");
        getContentPane().add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 510, 1460, 50));
        ...
        jLabel17.setText("by email at CaRoseTickets@gmail.com.");
        getContentPane().add(jLabel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 540, 1460, 50));

        pack();
        setLocationRelativeTo(null);
    }// </editor-fold>//GEN-END:initComponents
// Searchfield condiitions
