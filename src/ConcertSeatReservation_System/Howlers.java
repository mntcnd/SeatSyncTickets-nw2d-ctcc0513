...
public class Howlers extends javax.swing.JFrame {
...
// For images: bakcground, logo and poster
    public void Howlers() {
        ...
        ImageIcon icon2 = new ImageIcon("C:\\Users\\Mika\\OneDrive\\Documents\\NetBeansProjects\\CaseStudy_Finals\\Howlers.jpg");
...
// Creating components and setting its layout
    ...
    private void initComponents() {
        ...
        getContentPane().add(poster, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 120, 540, 680));
        ...
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 470, 1450, -1));

        jLabel4.setFont(new java.awt.Font("Copperplate Gothic Bold", 1, 36)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 255, 255));
        jLabel4.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel4.setText("Howlers Manila 2.0");
        ...
        jLabel1.setText("DJs, activities, and prizes to create the ultimate experience.");
        ...
        jLabel3.setText("Howlers Manila is a festival produced by VamosPH that ");
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 190, 820, 50));

        jLabel5.setFont(new java.awt.Font("Copperplate Gothic Light", 1, 24)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(255, 255, 255));
        jLabel5.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel5.setText("Howlers Manila provides a platform for people to express");
        ...
        jLabel6.setText("themselves in bold and daring ways. At VamosPH, we believe");
        ...
        jLabel10.setText("July 1, 2023 at 7:00 pm");
        getContentPane().add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 550, 490, 40));
        ...
        jLabel14.setText("Circuit Makati, Metro Manila, philippines");
        getContentPane().add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 640, 790, 40));

        jLabel15.setFont(new java.awt.Font("Copperplate Gothic Bold", 1, 24)); // NOI18N
        jLabel15.setForeground(new java.awt.Color(255, 255, 255));
        jLabel15.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel15.setText("Venue:");
        getContentPane().add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 610, -1, -1));
        ...
        getContentPane().add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 640, 600, 40));
        ...
        getContentPane().add(jPanel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 550, 600, 40));

        jLabel7.setFont(new java.awt.Font("Copperplate Gothic Light", 1, 24)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(255, 255, 255));
        jLabel7.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel7.setText("that music and fun experiences have the power to bring");
        ...
        jLabel8.setText("people together, create a sense of community, and help");
        ...
        jLabel9.setText("people disconnect from their worries and stress to create");
        ...
        jLabel13.setText("amazing memories.");
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 190, 840, 270));

        bg.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        bg.setOpaque(true);
        getContentPane().add(bg, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 70, 1550, 840));
...
// Searchfield conditions
    private void SearchFieldActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SearchFieldActionPerformed
     if (SearchField.getText().equalsIgnoreCase("Cravity") || SearchField.getText().equalsIgnoreCase("Masterpiece") || SearchField.getText().equalsIgnoreCase("Cravity In Manila")) {
            Cravity cv = new Cravity();
            cv.show();
            dispose();
        } else if (SearchField.getText().equalsIgnoreCase("Dhruv") || SearchField.getText().equalsIgnoreCase("Dhruv Live In Manila") || SearchField.getText().equalsIgnoreCase("Dhruv In Manila")) {
            Dhruv dv = new Dhruv();
            dv.show();
            dispose();
        } else if (SearchField.getText().equalsIgnoreCase("Howlers") || SearchField.getText().equalsIgnoreCase("Howlers 2.0") || SearchField.getText().equalsIgnoreCase("Howlers In Manila")) {
            Howlers hl = new Howlers();
            hl.show();
            dispose();
        } else if (SearchField.getText().equalsIgnoreCase("Ikon") || SearchField.getText().equalsIgnoreCase("Ikon in Manila") || SearchField.getText().equalsIgnoreCase("Ikon World Tour") || SearchField.getText().equalsIgnoreCase("Take Off")) {
            IKon ik = new IKon();
            ik.show();
            dispose();
        } else if (SearchField.getText().equalsIgnoreCase("NMixx") || SearchField.getText().equalsIgnoreCase("NMixx Showcase Tour") || SearchField.getText().equalsIgnoreCase("Nice to Mixx You") || SearchField.getText().equalsIgnoreCase("NMixx in Manila")) {
            IKon ik = new IKon();
            ik.show();
            dispose();
        } else if (SearchField.getText().equalsIgnoreCase("SB19") || SearchField.getText().equalsIgnoreCase("SB19 Pagtatag") || SearchField.getText().equalsIgnoreCase("SB19 in Davao") || SearchField.getText().equalsIgnoreCase("SB19 World Tour")) {
            SB19 sb19 = new SB19();
            sb19.show();
            dispose();
        } else if (SearchField.getText().equalsIgnoreCase("SSRFest") || SearchField.getText().equalsIgnoreCase("Parokya ni Edgar") || SearchField.getText().equalsIgnoreCase("Sponge Cola")) {
            SSRFest sr = new SSRFest();
            sr.show();
            dispose();
        } else if (SearchField.getText().equalsIgnoreCase("SarahGxBamboo") || SearchField.getText().equalsIgnoreCase("SarahG") || SearchField.getText().equalsIgnoreCase("Bamboo")) {
            SarahGxBamboo sb = new SarahGxBamboo();
            sb.show();
            dispose();
        } else if (SearchField.getText().equalsIgnoreCase("TXT") || SearchField.getText().equalsIgnoreCase("TXT World Tour") || SearchField.getText().equalsIgnoreCase("Act Sweet Mirage")) {
            TXT tx = new TXT();
            tx.show();
            dispose();
        } else if (SearchField.getText().equalsIgnoreCase("Super Stage") || SearchField.getText().equalsIgnoreCase("Kpop in Manila") || SearchField.getText().equalsIgnoreCase("Kepler") || SearchField.getText().equalsIgnoreCase("Kep1er") || SearchField.getText().equalsIgnoreCase("Lapillus") || SearchField.getText().equalsIgnoreCase("Mamamoo")) {
            SuperStage ss = new SuperStage();
            ss.show();
            dispose();
        } else if (SearchField.getText().equalsIgnoreCase("Taeyeon") || SearchField.getText().equalsIgnoreCase("Taeyeon in Manila") || SearchField.getText().equalsIgnoreCase("The Odd of Love") || SearchField.getText().equalsIgnoreCase("Odd") || SearchField.getText().equalsIgnoreCase("Odd Love")) {
            Taeyeon ty = new Taeyeon();
            ty.show();
            dispose();
        } else if (SearchField.getText().equalsIgnoreCase("The Juans") || SearchField.getText().equalsIgnoreCase("The Juans in Cebu") || SearchField.getText().equalsIgnoreCase("TJ")) {
            TheJuans tj = new TheJuans();
            tj.show();
            dispose();
        } else if (SearchField.getText().equalsIgnoreCase("The Boyz") || SearchField.getText().equalsIgnoreCase("The Boyz Manila") || SearchField.getText().equalsIgnoreCase("The Boyz in Manila") || SearchField.getText().equalsIgnoreCase("TBZ") || SearchField.getText().equalsIgnoreCase("The Boyz Zenerarion") || SearchField.getText().equalsIgnoreCase("Zeneration")) {
            The_Boyz tbz = new The_Boyz();
            tbz.show();
            dispose();
        } else if (SearchField.getText().equalsIgnoreCase("Twice") || SearchField.getText().equalsIgnoreCase("Twice Ready To Be") || SearchField.getText().equalsIgnoreCase("Twice World Tour") || SearchField.getText().equalsIgnoreCase("RTB")) {
            Twice rtb = new Twice();
            rtb.show();
            dispose();
        } else if (SearchField.getText().equalsIgnoreCase("Seventeen") || SearchField.getText().equalsIgnoreCase("Seventeen Be The Sun") || SearchField.getText().equalsIgnoreCase("Be The Sun") || SearchField.getText().equalsIgnoreCase("Seventeen World Tour") || SearchField.getText().equalsIgnoreCase("SVT")) {
            JOptionPane.showMessageDialog(null, "Sorry, Seventeen: Be The Sun event is already done.");
        } else if (SearchField.getText().equalsIgnoreCase("Enhypen") || SearchField.getText().equalsIgnoreCase("Enhypen Manifesto") || SearchField.getText().equalsIgnoreCase("Manifesto") || SearchField.getText().equalsIgnoreCase("Enhypen World Tour")) {
            JOptionPane.showMessageDialog(null, "Sorry, Enhypen: Manifesto Tour event is already done.");
        } else if (SearchField.getText().equalsIgnoreCase("Itzy") || SearchField.getText().equalsIgnoreCase("Itzy Checkmate") || SearchField.getText().equalsIgnoreCase("Checkmate") || SearchField.getText().equalsIgnoreCase("Itzy World Tour")) {
            JOptionPane.showMessageDialog(null, "Sorry, Itzy: Checkmate World Tour event is already done.");
        } else if (SearchField.getText().equalsIgnoreCase("Straykids") || SearchField.getText().equalsIgnoreCase("Straykids Maniac Tour") || SearchField.getText().equalsIgnoreCase("Maniac") || SearchField.getText().equalsIgnoreCase("SKZ") || SearchField.getText().equalsIgnoreCase("straykids World Tour")) {
